...
import os
from concrete.entity.config_entity import TRANSFORMER_OBJECT_FILE_NAME,MODEL_FILE_NAME,TARGET_SCALER_OBJECT_FILE_NAME
...
class ModelResolver:
    def __init__(self,model_registry:str = "saved_models",
                ...
                target_scaler_dir_name="target_scaler",
    ...
    def get_latest_target_scaler_path(self):
        try:
            latest_dir=self.get_latest_dir_path()
            if latest_dir is None:
                raise Exception(f"Target scaler is not available")
