...
class DataValidation:
        ...
        try:
            ...
            for base_column in base_columns:
                if base_column not in current_columns:
                    logging.info(f"column:[{base} ia not available]")
    ...
    def initiate_data_validation(self,)->artifact_entity.DataValidationArtifact:
        try:
            ...
            train_df_columns_status=self.is_required_column_exists(base_df=base_df, current_df=train_df,report_key_name="missing_column_within_train_dataset")
            logging.info(f"Is all required columns present in test df")
            test_df_columns_status=self.is_required_column_exists(base_df=base_df, current_df=test_df,report_key_name="missing_column_within_test_dataset")
